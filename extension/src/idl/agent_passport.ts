...
export type AgentPassport = {
  ...
  instructions: [
    {
      ...
      discriminator: [198, 21, 251, 56, 20, 59, 143, 23];
      accounts: [
        {
          name: "authority";
          docs: [
    ...
    },
    {
      ...
      discriminator: [61, 77, 198, 139, 101, 90, 68, 137];
      accounts: [
        {
          name: "authority";
          docs: ["Owner wallet: authority + rent payer. Signs the write."];
          writable: true;
          signer: true;
        },
        {
          name: "passport";
          docs: ["Passport PDA, seeded by the agent identity pubkey."];
          writable: true;
          pda: {
            seeds: [
              {
    ...
    },
    {
      ...
      accounts: [
        {
          name: "authority";
          docs: ["Must equal the passport's stored authority."];
          signer: true;
          relations: ["passport"];
        },
        {
  ...
  accounts: [
    {
      name: "passport";
      discriminator: [18, 61, 245, 239, 6, 15, 18, 34];
    },
  ];
  events: [
    {
      name: "passportClosed";
      discriminator: [250, 79, 10, 165, 212, 71, 11, 186];
    },
    {
      name: "passportInitialized";
      discriminator: [231, 242, 181, 232, 74, 20, 32, 137];
    },
    {
      name: "passportUpdated";
      discriminator: [55, 139, 137, 64, 153, 163, 91, 26];
    },
  ];
  errors: [
    {
  ...
  types: [
    {
      ...
      type: {
        ...
        fields: [
          {
            name: "version";
            docs: ["Schema version (starts at 1; bump on layout change)."];
            type: "u8";
          },
          {
            name: "bump";
          ...
          {
            name: "createdAt";
            docs: ["Creation time, Unix SECONDS."];
            type: "i64";
          },
          {
            name: "updatedAt";
            docs: ["Last update time, Unix SECONDS."];
            type: "i64";
          },
        ];
      };
